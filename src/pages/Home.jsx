                    ...
                    <div className="w-full bg-blue-800 py-5 md:py-10">
                         <div className="flex flex-col md:flex-row items-start md:items-center mx-5 md:mx-15 justify-between gap-5">
                              ...
                              <div className="flex h-fit">
                                   ...
                                   <a href="#">
                                        <Button label="Join Group" bgColor="bg-white" textColor="text-blue-800" hoverBg="bg-black" iconBg="bg-blue-800" iconColor="text-white" />
                                   </a>
                              </div>
                         </div>
                    </div>
                    ...
                    <div className="w-full bg-blue-800 py-5 md:py-10">
                         <div className="flex flex-col md:flex-row items-start md:items-center mx-5 md:mx-15 justify-between gap-5">
                              ...
                              <div className="flex h-fit">
                                   <img src={iconMoveRight} alt="icon move right" className="hidden md:block animate-move-left-right" />
                                   <a href="#">
                                        <Button label="View Apostolic Centers" bgColor="bg-white" textColor="text-blue-800" hoverBg="bg-black" iconBg="bg-blue-800" iconColor="text-white" />
                                   </a>
                              </div>
                         </div>
                    </div>
