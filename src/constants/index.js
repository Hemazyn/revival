...
import { cr1, cr2, cr3, infoBg } from "../assets";
...
const pastors = [
     {
          name: "Pastor Femi Salawu",
          title: "President",
          image: infoBg,
          description: "A man of prayer, revivalist, teacher, discipler and a prophet to nations.",
     ...
     },
     {
          ...
          image: cr2,
          description: "An inspiring leader with a heart for missions and empowering women.",
     ...
     },
     {
          ...
          title: "Youth Pastor",
          image: cr3,
          description: "Dedicated to mentoring young minds and leading the next generation in truth.",
...
export { links, slides, programList, pastors };
